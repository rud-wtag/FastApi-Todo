...
from app.core.constants import ADMIN, EMAIL_VERIFICATION_TOKEN
...
class TestUserRegistrationService:
    ...
    def test_verify_email(
        ...
        respoonse = user_registration_service.verify_email(
           self.token, request
        )
        ...
        mock_get_html().TemplateResponse.assert_called_once_with("email-verification-success.html",
        ...
        mock_get_html().TemplateResponse.assert_called_with("email-verification-success.html",
